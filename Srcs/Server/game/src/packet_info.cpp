...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set (HEADER_CG_GUILD_SYMBOL_CRC,			sizeof (TPacketCGSymbolCRC),			"SymbolCRC");
	...
	Set(HEADER_CG_67_ATTR, sizeof(TPacketCG67Attr), "67Attr");
	Set(HEADER_CG_CLOSE_67_ATTR, sizeof(TPacket67AttrOpenClose), "67AttrClose");
#endif
#if defined(__BL_MOVE_CHANNEL__)
	Set(HEADER_CG_MOVE_CHANNEL, sizeof(TPacketCGMoveChannel), "MoveChannel");
#endif
#if defined(__BL_MOVE_COSTUME_ATTR__)
	Set(HEADER_CG_ITEM_COMBINATION, sizeof(TPacketCGItemCombination), "ItemCombination");
	Set(HEADER_CG_ITEM_COMBINATION_CANCEL, sizeof(TPacketCGItemCombinationCancel), "ItemCombinationCancel");
#endif
	...
	Set (HEADER_CG_GIVE_ITEM,			sizeof (TPacketCGGiveItem),			"ItemGive");
	...
	Set(HEADER_CG_CHANGE_EQUIP, sizeof(TChangeEquipment), "ChangeEquipment");
#endif
	...
	Set(HEADER_CG_LOOT_FILTER, sizeof(TPacketCGLootFilter), "LootFilter");
#endif
...
#endif
#ifdef ENABLE_DS_SET
	Set(HEADER_GC_DS_TABLE, sizeof(TPacketDSTable), "DSTable");
#endif
}
