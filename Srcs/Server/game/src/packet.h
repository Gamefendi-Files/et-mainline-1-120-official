...
HEADER_GC_DRAGON_SOUL_CHANGE_ATTR		= 236,
	...
	HEADER_CG_TRANSMUTATION = 239,
#endif
#if defined(__BL_TRANSMUTATION__)
	HEADER_GC_TRANSMUTATION_SET = 245,
	HEADER_GC_TRANSMUTATION_DEL = 246,
	HEADER_GC_TRANSMUTATION_FREE_SET = 247,
	HEADER_GC_TRANSMUTATION_FREE_DEL = 248,
#endif
