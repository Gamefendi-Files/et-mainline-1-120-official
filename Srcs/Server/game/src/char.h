...
protected:
	...
	public:
		...
		void			SetPetPay(LPITEM PetItem) noexcept { m_petitem = PetItem; }
		LPITEM			GetPetPay() const noexcept { return m_petitem; }
	private:
		LPITEM m_petitem;
	#endif
		#endif
