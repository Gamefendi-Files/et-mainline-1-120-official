...
class CBuyerThiefGloveItemGroup
{
	...
	public:
		CBuyerThiefGloveItemGroup (DWORD dwVnum, DWORD dwMobVnum, const std::string& r_stName)
			:
			m_dwVnum (dwVnum),
			m_dwMobVnum (dwMobVnum),
			m_stName (r_stName)
...
class ITEM_MANAGER : public singleton<ITEM_MANAGER>
{
	...
	protected:
		...
		std::map<DWORD, CBuyerThiefGloveItemGroup*> m_map_pkGloveItemGroup;
