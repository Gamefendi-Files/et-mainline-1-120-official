...
void CClientManager::QUERY_PLAYER_LOAD (CPeer* peer, DWORD dwHandle, TPlayerLoadPacket* packet)
{
	...
	else
	{
		...
		snprintf (queryStr, sizeof (queryStr),
				  ...
				  "conquerorlevel,conqueror_level_step,sungma_str,sungma_hp,sungma_move,sungma_immune,conqueror_exp,conqueror_point,"
...
void CClientManager::__QUERY_PLAYER_CREATE (CPeer* peer, DWORD dwHandle, TPlayerCreatePacket* packet)
{
	...
	queryLen = snprintf (queryStr, sizeof (queryStr),
						 ...
						 "job, voice, dir, x, y, z, "
#ifdef ENABLE_ADDITIONAL_EQUIPMENT_PAGE
						 "hp, mp, random_hp, random_sp, stat_point, stamina, part_base, part_main, part_hair, part_acce, gold, equip_index, playtime, "
#else
