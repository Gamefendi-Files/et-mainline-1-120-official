...
#if defined(ENABLE_ITEM_ATTR_COSTUME) && defined(__WEAPON_COSTUME_SYSTEM__)
		", costume_weapon"
#endif
#endif
	...
	for (itertype (m_vec_itemTable) it = m_vec_itemTable.begin(); it != m_vec_itemTable.end(); it++)
	{
		if (g_stLocaleNameColumn != "name")
		{
			...
			snprintf (query, sizeof (query),
					  ...
					  t.aApplies[0].wType, t.aApplies[0].lValue, t.aApplies[1].wType, t.aApplies[1].lValue, t.aApplies[2].wType, t.aApplies[2].lValue,
