...
PyModule_AddIntConstant(poModule, "WJ_NEW_DROP_DIALOG", 0);
	...
	PyModule_AddIntConstant(poModule, "VIEW_TARGET_PLAYER_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "VIEW_TARGET_PLAYER_HP", 0);
#endif

#if defined(VIEW_TARGET_DECIMAL_HP)
	PyModule_AddIntConstant(poModule, "VIEW_TARGET_DECIMAL_HP", 1);
#else
	PyModule_AddIntConstant(poModule, "VIEW_TARGET_DECIMAL_HP", 0);
#endif
...
#endif
#ifdef ITEM_ANTIFLAG_TOOLTIP
	PyModule_AddIntConstant(poModule, "ITEM_ANTIFLAG_TOOLTIP", 1);
#else
	PyModule_AddIntConstant(poModule, "ITEM_ANTIFLAG_TOOLTIP", 0);
#endif
