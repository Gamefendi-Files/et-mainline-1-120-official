...
enum
{
	...
	HEADER_CG_ITEM_DESTROY			= 139,
	HEADER_CG_ITEM_SELL				= 140,
#endif
	//HEADER_BLANK21					= 21,
	//HEADER_BLANK22					= 22,
	//HEADER_BLANK22					= 23,
	...
	HEADER_CG_CHEST_DROP_INFO				= 242,
#endif
#ifdef ENABLE_SHOW_CHEST_DROP
	HEADER_GC_CHEST_DROP_INFO						= 219,
#endif
#ifdef ENABLE_TARGET_INFORMATION_SYSTEM
	HEADER_CG_TARGET_INFO_LOAD = 220,
#endif
#ifdef ENABLE_TARGET_INFORMATION_SYSTEM
	HEADER_GC_TARGET_INFO = 221,
#endif
#ifdef ENABLE_CONQUEROR_LEVEL
	HEADER_GC_SUNGMA_ATTR_UPDATE = 231,
#endif
#if defined(__BL_67_ATTR__)
	HEADER_CG_67_ATTR 						= 232,
	HEADER_CG_CLOSE_67_ATTR 				= 233,
#endif
#if defined(__BL_67_ATTR__)
	HEADER_GC_OPEN_67_ATTR 						= 234,
#endif
#ifdef ENABLE_DS_SET
	HEADER_GC_DS_TABLE = 235,
#endif
#ifdef ENABLE_DS_CHANGE_ATTR
HEADER_GC_DRAGON_SOUL_CHANGE_ATTR			= 236,
#endif
#if defined(__BL_MOVE_COSTUME_ATTR__)
	HEADER_CG_ITEM_COMBINATION = 237,
	HEADER_CG_ITEM_COMBINATION_CANCEL = 238,
#endif
#if defined(__BL_TRANSMUTATION__)
	HEADER_CG_CHANGE_LOOK = 239,
#endif
#if defined(__BL_TRANSMUTATION__)
	HEADER_GC_CHANGE_LOOK_SET = 245,
	HEADER_GC_CHANGE_LOOK_DEL = 246,
	HEADER_GC_CHANGE_LOOK_FREE_SET = 247,
	HEADER_GC_CHANGE_LOOK_FREE_DEL = 248,
#endif
...
//	POINT_SKILL_ACTIVE,		 // 28 액티브 스킬 포인트
	...
	POINT_ENCHANT_ELECT = 143,
	POINT_ENCHANT_FIRE = 144,
	POINT_ENCHANT_ICE = 145,
	POINT_ENCHANT_WIND = 146,
	POINT_ENCHANT_EARTH = 147,
	POINT_ENCHANT_DARK = 148,
	...
	POINT_RESIST_HUMAN = 155,
#endif
	POINT_ATTBONUS_STONE = 156,
	POINT_ATTBONUS_BOSS =157,
#ifdef ENABLE_ACCE_SYSTEM
		POINT_ACCEDRAIN_RATE = 158,
#endif
#ifdef ENABLE_CONQUEROR_LEVEL	
	POINT_CONQUEROR_LEVEL = 159,
	POINT_CONQUEROR_LEVEL_STEP = 160,
	POINT_SUNGMA_STR = 161,
	POINT_SUNGMA_HP = 162,
	POINT_SUNGMA_MOVE = 163,
	POINT_SUNGMA_IMMUNE = 164,
	POINT_CONQUEROR_POINT = 165,
	POINT_CONQUEROR_EXP = 166,
	POINT_CONQUEROR_NEXT_EXP = 167,
#endif
